...
func GetRangeTypes(connectionPool *dbconn.DBConn) []RangeType {
	...
	WHERE %s AND t.typtype = 'r' AND %s`, SchemaFilterClause("n"), ExtensionFilterClause("t"))
