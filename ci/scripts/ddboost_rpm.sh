...
cp ${GPBACKUP_DIR}/gppkg/ddboost.spec.in ${RPMROOT}/SPECS/ddboost.spec

rpmbuild -bb ${RPMROOT}/SPECS/ddboost.spec --define "%_topdir ${RPMROOT}" --define "debug_package %{nil}" --define "ddboost_version $DDBOOST_VERSION"
